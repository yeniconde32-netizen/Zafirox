...
with st.sidebar:
    ...
    menu_opcion = st.selectbox(
        ...
        [
            "🎁 Caja Misteriosa",
            "💎 Caza de Gemas (Difícil)",
            "🎡 Ruleta de la Suerte",
            "🧩 Minijuego Retro (Bloques)",
            "🐍 Minijuego Snake",
...
# 1. Caza de Gemas (Versión Difícil: 9 casillas)
...
# 2. Ruleta de la Suerte (Imagen Grande)
...
# 3. Minijuego de Bloques Estilo Arcade
elif "Minijuego Retro" in menu_opcion:
...
# 4. Minijuego Snake (Culebrita)
elif "Minijuego Snake" in menu_opcion:
...
# 5. Ver Videos Premiados (Anuncio Corto / Monetag)
...
# 6. Sesión de Video con Reto
elif "Sesión de Video con Reto" in menu_opcion:
